package com.yeniyoo.tools.circleprogress;
...
public class CircleProgressView extends View {
    ...
    private final int mBarColorStandard = 0x00dfdfdf; //stylish blue
    private int mContourColor = 0x00dfdfdf;
    private int mSpinnerColor = mBarColorStandard; //stylish blue
    private int mBackgroundCircleColor = 0x00000000;  //transparent
    private int mRimColor = 0x00dfdfdf;
