 ...
 *
 */
package com.yeniyoo.tools.progresspercent;
...
abstract class BaseProgressView extends View {
    ...
    protected int color = getResources().getColor(R.color.accent), backgroundColor = Color.WHITE;
    protected int textColor = getResources().getColor(R.color.primary_dark);
